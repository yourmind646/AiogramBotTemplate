# sqlalchemy import
from sqlalchemy import update, select, delete, any_
...
async_engine = create_async_engine(
	url = f"postgresql+asyncpg://{db_config.get('user')}:{db_config.get('password')}@{db_config.get('host')}:{db_config.get('port')}/{db_config.get('database')}"
)
